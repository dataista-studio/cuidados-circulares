export default function Credits() {
    return (
        <div  className="h-screen w-screen bg-verde-oscuro flex  flex-col justify-center items-center gap-12">
            ...
            <div  className="text-[22px] text-verde-claro flex flex-col gap-2">
                ...
                <h4 className="">Datos</h4>

                <a href="https://www.inegi.org.mx/contenidos/programas/enasic/2022/doc/enasic_2022_presentacion.pdf">Encuesta Nacional sobre Uso del Tiempo (ENASIC), INEGI (2022).</a>

                <a href="https://observatorio.ministeriodesarrollosocial.gob.cl/storage/docs/cuidados/Informe_de_Cuidados-2024.pdf">Informe de cuidados, Observatorio Social. Ministerio de Desarrollo Social y Familia (2024).</a>

                <a href="https://lac.unwomen.org/sites/default/files/Field%20Office%20Americas/Documentos/Publicaciones/2018/11/Estudio%20cuidados/2a%20UNW%20Estudio%20Cuidados-compressed.pdf">Informe “Reconocer, redistribuir y reducir el trabajo de cuidados”, ONU Mujeres (2018).</a>

                <a href="https://www.one.gob.do/media/xlldcplu/panorama-estad%C3%ADstico-116.pdf">Panorama estadístico, Oficina Nacional de Estadística (2024).</a>
                
                <a href="https://oig.cepal.org/sites/default/files/2025-11/original_folleto-repositorio-uso-del-tiempo_04-11-2025.pdf">Repositorio uso del tiempo, Observatorio de Igualdad de Género. CEPAL, ONU Mujeres (2025).</a>
                
            </div>

            <div  className="text-[22px] text-verde-claro flex flex-col gap-2">

                <h4 className="">Imágenes</h4>
